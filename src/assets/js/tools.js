...
const BIloading = {
  ...
  startLoading() {
    this.loadingInstance = Loading.service({lock: true, text: '数据加载中……', background: 'rgba(255, 255, 255, 0.5)',target:'#layout',customClass:'BI-loading'})
  },
  endLoading() {
    this
      .loadingInstance
...
// 消息提示
const BIMsg = (opt) => {
  let option = Object.assign({}, {customClass: `msg_background_${store.state.themeColor}`,	duration:2500,type:'info'},opt)
  return Message(option)
}
export {formatTime, handleChinese, exportPng, BIloading, BIMsg}