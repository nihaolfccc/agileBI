<template>
  ...
  <div class="root" style="opacity: 0;" do-root>
    ...
    <!-- Group2 -->
    <div class="group" style="left: 366px; top: 111px;">   <!--left: 279px-->
    ...
    <!-- Node -->
    <div class="node01" style="left: 640px; top: 376px;" do-item-id="n1"> <!--left: 802px-->
      数据汇聚
    </div>
    <div class="node01" style="left: 1054px; top: 376px;" do-item-id="n2"> <!--left: 1878px-->
      数据应用
    </div>
    <div class="node01" style="left: 1320px; top: 376px;" do-item-id="n3"> <!--left: 2279px-->
      数据服务
    </div>

    <!-- Core -->
    <div class="group" style="left: 680px; top: 326px; width: 595px;"> <!--left: 1114px; top: 326px; width: 613px-->
      <div style="text-align: center; color: #FFF; font-size: 28px; font-weight: bold;" do-item-id="c_t"> <!--font-size: 30px-->
        大数据平台
      </div>
    ...
    <!-- Group4 -->
    <div class="group" style="left: 1420px; top: 68px;"> <!--left: 2077px-->
      <div class="rect03" style="left: 0px; top: 0px;" do-item-id="g4_1">
        <div class="name03">监测预警</div>
        <div class="numeric03">1024</div>
      </div>
      <div class="rect03" style="left: 0px; top: 100px;" do-item-id="g4_2">
        <div class="name03">质量分级</div>
        <div class="numeric03">1024</div>
      </div>
      <div class="rect03" style="left: 0px; top: 200px;" do-item-id="g4_3">
        <div class="name03">质量追溯</div>
        <div class="numeric03">1024</div>
      </div>
      <div class="rect03" style="left: 0px; top: 300px;" do-item-id="g4_4">
        <div class="name03">生猪物流</div>
        <div class="numeric03">1024</div>
      </div>
      <div class="rect03" style="left: 0px; top: 400px;" do-item-id="g4_5">
        <div class="name03">企业征信</div>
        <div class="numeric03">1024</div>
      </div>
      <div class="rect03" style="left: 0px; top: 500px;" do-item-id="g4_6">
        <div class="name03">生猪保险</div>
        <div class="numeric03">1024</div>
      </div>
      <div class="rect03" style="left: 0px; top: 600px;" do-item-id="g4_7">
        <div class="name03">进出口情报</div>
        <div class="numeric03">1024</div>
      </div>
      <div class="rect03" style="left: 0px; top: 700px;" do-item-id="g4_8">
        <div class="name03">产学研转化</div>
        <div class="numeric03">1024</div>
      </div>
      <div class="ellipsis03 rect03" style="left: 0px; top: 800px;" do-item-id="g4_e">
        ... ...
      </div>
    </div>

    <!-- Group5 -->
    <div class="group" style="left: 1754px; top: 118px;"> <!--left: 2477px-->
      <div class="rect01" style="left: 0px; top: 0px;" do-item-id="g5_1">
        <div class="name01">农业部</div>
        <div class="numeric01">1024</div>
      </div>
      <div class="rect01" style="left: 0px; top: 100px;" do-item-id="g5_2">
        <div class="name01">市政府</div>
        <div class="numeric01">1024</div>
      </div>
      <div class="rect01" style="left: 0px; top: 200px;" do-item-id="g5_3">
        <div class="name01">市农委</div>
        <div class="numeric01">1024</div>
      </div>
      <div class="rect01" style="left: 0px; top: 300px;" do-item-id="g5_4">
        <div class="name01">外厅局</div>
        <div class="numeric01">1024</div>
      </div>
      <div class="rect01" style="left: 0px; top: 400px;" do-item-id="g5_5">
        <div class="name01">区县农业局</div>
        <div class="numeric01">1024</div>
      </div>
      <div class="rect01" style="left: 0px; top: 500px;" do-item-id="g5_6">
        <div class="name01">公众</div>
        <div class="numeric01">1024</div>
      </div>
      <div class="rect01" style="left: 0px; top: 600px;" do-item-id="g5_7">
        <div class="name01">企业</div>
        <div class="numeric01">1024</div>
      </div>
      <div class="ellipsis01 rect01" style="left: 0px; top: 700px;" do-item-id="g5_e">
        ... ...
      </div>
    </div>
...
<style lang="scss" scoped>
  ...
  .ellipsis01, .ellipsis02, .ellipsis03 {
    font-weight: bold;
    font-size: 22px;
    text-align: center;
    color: #dd2911;
