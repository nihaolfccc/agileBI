<template>
	<div class="relationExtraction">
		<div class="re_begin" v-show="!showProgress">
			<img src="../../assets/imgs/relation-extraction.png" alt="" />
			<button class="begin_task" @click="relatuinAjax">知识图谱构建</button>
...
<style scoped lang="scss" rel="stylesheet/scss">
	.relationExtraction {
		...
		.begin_task {
			...
			color: #ffffff;
			font-size: 18px;
			background: url(../../assets/imgs/begin_task.png) no-repeat;
